defmodule BookmovesWeb.UserAuth do
  use BookmovesWeb, :verified_routes

  import Plug.Conn
  import Phoenix.Controller

  alias Bookmoves.Accounts
  alias Bookmoves.Accounts.Scope

  # Make the remember me cookie valid for 14 days. This should match
  # the session validity setting in UserToken.
  @max_cookie_age_in_days 14
  @remember_me_cookie "_bookmoves_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      BookmovesWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  @doc """
  LiveView mount hook to assign the current scope or require authentication.
  """
